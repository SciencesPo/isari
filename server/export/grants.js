        ...
        (mongoQuery,next2) => {
          ...
          .then(activities => {
              ...
              let grantInfosHeaders = [
                    ...
                    {key:'projectManagers', label:'Chef.s de projet'},
                    {key:'projectManagersEmails', label:'Chef.s de Projet email.s'},
                    {key:'sciencesPomProjectManagers', label:'nb CP SCPO m', 'accessType': 'confidential'},
                    {key:'sciencesPofProjectManagers', label:'nb CP SCPO f', 'accessType': 'confidential'},
                    {key:'sciencesPooProjectManagers', label:'nb CP SCPO a', 'accessType': 'confidential'},
                    //grant meta
